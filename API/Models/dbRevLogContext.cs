...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Consignee>(entity =>
            {
                ...
                entity.Property(e => e.RevLogUserId).IsRequired();
                ...
                entity.HasOne(d => d.RevLogUser)
                    ...
                    .HasConstraintName("FK_Consignee_AspNetUsers");

                entity.HasOne(d => d.RevLogUserNavigation)
                    .WithMany(p => p.Consignee)
                    .HasForeignKey(d => d.RevLogUserId)
            ...
            modelBuilder.Entity<Quotation>(entity =>
            {
                ...
                entity.Property(e => e.ConsigneeId).HasMaxLength(450);
